...
export default function TrustedCompanies() {
    return (
        <section className="flex flex-col items-center">
            <SectionTitle title="Supporting Amphibian Science" description="Frogzs is trusted by researchers, educators, and conservation organizations worldwide." />
            ...
            >
                ...
                <div className="flex flex-col items-center md:items-start max-md:text-center">
                    <a href="#about" className="group flex items-center gap-2 rounded-full text-sm p-1 pr-3 text-indigo-300 bg-indigo-200/15">
                        <span className="bg-indigo-600 text-white text-xs px-3.5 py-1 rounded-full">
                            FEATURED
                        </span>
                        <p className="flex items-center gap-1">
                            <span>Explore our core features </span>
                    ...
                    <h1 className="text-3xl font-medium max-w-xl mt-5 bg-gradient-to-r from-white to-[#b6abff] text-transparent bg-clip-text">Powered by Conservation</h1>
                    <p className="text-base text-slate-400 max-w-lg mt-4">
                        Frogzs combines cutting-edge AI technology with amphibian science to help citizens contribute to biodiversity research and conservation efforts.
                    </p>
